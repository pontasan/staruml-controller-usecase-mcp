...
4. The HTTP server starts — all Use Case Diagram tools become available via MCP
...
```bash
claude mcp add staruml-usecase node /absolute/path/to/staruml-controller-usecase-mcp/dist/index.js
```
